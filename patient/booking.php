                ...
                <tr >
                    ...
                    <td >
                            <form action="schedule.php" method="post" class="header-search">
                                        ...
                                        <input type="search" name="search" class="input-text header-searchbar"  list="doctors" >&nbsp;&nbsp;
                            ...
                            if(($_GET)){
                                ...
                                if(isset($_GET["id"])){
                                    ...
                                    <td style="width: 50%;" rowspan="2">
                                        ...
                                        <tr>
                                            <td>
                                                <input type="Submit" class="login-btn btn-primary btn btn-book" style="margin-left:10px;padding-left: 25px;padding-right: 25px;padding-top: 10px;padding-bottom: 10px;width:95%;text-align: center;" value="Agendar ahora" name="booknow"></button>
                                            </form>
                                            </td>
                                        </tr>
                                        '; 
