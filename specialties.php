...
<div
    ...
    <div class="mx-auto p-8">
        <h1
          class="text-left max-w-lg mb-6 font-sans text-3xl font-bold tracking-tight sm:text-4xl sm:leading-relaxed mx-auto mt-10"
        >
          Especialidades que encontras en <span class="text-blue-500 uppercase">Kytos</span>
        </h1>
        <?php
